...
*Автоматично згенеровано: 2025-12-13T18:36:35.323546*
*Оновлюється автоматично при кожному запуску системи*

====================================================================================================
## 📊 ЗАГАЛЬНА ІНФОРМАЦІЯ
====================================================================================================
- **Загальна кількість модулів**: 29
- **Секції конфігурації**: 14
- **Активних компонентів**: 40
...
- `[13]` **p_013_report_cleaner** - Модуль для очищення застарілих звітів конфігурації та проекту.
...
- `[356]` **p_356_ui_styles** - p_356_ui_styles.py - Стилі для UI компонентів.
- `[357]` **p_357_ui_utils** - 
- `[360]` **p_360_tts_gradio_advanced_ui_(mono)** - p_353_tts_gradio_advanced_ui.py - Розширений Gradio UI для Multi Dialog TTS.
...
- **p_354_ui_builder** ← p_356_ui_styles, p_357_ui_utils, p_355_ui_handlers

====================================================================================================
## 🤖 ДЛЯ ШІ: Інтеграція та використання
*Автоматично згенеровано: 2025-12-13 18:36:35*
...
**Конфігурація:**
  ...
  - `p_010_config_collector` - Сервісний компонент системи (ConfigCollector)
  - `p_020_config_validator` - Сервісний компонент системи (Config)
...
**TTS компоненти:**
  - `p_303_tts_models` - Сервісний компонент системи (TTSModels)
  - `p_360_tts_gradio_advanced_ui_(mono)_demo` - Сервісний компонент системи (Blocks)
...
**Графічні інтерфейси:**
  - `demo` - Сервісний компонент системи (Blocks)
  - `gui_manager` - Менеджер графічних інтерфейсів (GUIManager)
  - `p_090_gui_manager` - Сервісний компонент системи (GUIManager)
  - `p_353_advanced_ui_core_demo` - Сервісний компонент системи (Blocks)
...
**Інше:**
  ...
  - `engine` - Сервісний компонент системи (TTSEngine)
  - `modules` - Сервісний компонент системи (list)
  - `p_013_report_cleaner` - Сервісний компонент системи (ReportCleaner)
  - `p_050_universal_deps_checker` - Сервісний компонент системи (UniversalDependencyChecker)
  - `p_060_error_handler` - Сервісний компонент системи (ErrorHandler)
  - `p_075_events` - Сервісний компонент системи (EventBus)
  - `p_080_registry` - Сервісний компонент системи (ActionRegistry)
  - `p_100_logger` - Сервісний компонент системи (Logger)
  - `p_351_sfx_handler` - Сервісний компонент системи (SFXHandler)
  - `p_352_dialog_parser` - Сервісний компонент системи (DialogParser)
  - `p_356_ui_styles` - Сервісний компонент системи (UIStyles)
  - `p_901_project_info` - Сервісний компонент системи (ProjectInfoCollector)
  - `report_cleaner` - Сервісний компонент системи (dict)
  - `sfx_handler` - Сервісний компонент системи (SFXHandler)
  - `status` - Сервісний компонент системи (str)
  - `ui_styles` - Сервісний компонент системи (UIStyles)

...
*Автоматично згенеровано: 2025-12-12T19:55:32.271914*
...
- `[353]` **p_353_advanced_ui_core** - 
- `[354]` **p_354_ui_builder** - 
- `[355]` **p_355_ui_handlers** - 
- `[356]` **p_356_ui_styles** - 
- `[357]` **p_357_ui_utils** - 
- `[360]` **p_360_tts_gradio_advanced_ui_** - p_353_tts_gradio_advanced_ui.py - Розширений Gradio UI для Multi Dialog TTS.
...
- **p_354_ui_builder** ← p_355_ui_handlers, p_357_ui_utils, p_356_ui_styles
- **p_355_ui_handlers** ← p_357_ui_utils

====================================================================================================
## 🤖 ДЛЯ ШІ: Інтеграція та використання
*Автоматично згенеровано: 2025-12-12 19:55:32*
...
**TTS компоненти:**
  ...
  - `360_tts_gradio_advanced_ui_` - Сервісний компонент системи (dict)

...
*Автоматично згенеровано: 2025-12-11T19:03:45.691236*
*Оновлюється автоматично при кожному запуску системи*

====================================================================================================
## 📊 ЗАГАЛЬНА ІНФОРМАЦІЯ
====================================================================================================
- **Загальна кількість модулів**: 33
- **Секції конфігурації**: 17
- **Активних компонентів**: 43
...
- `[999]` **p_999_raw_url_generator** - Модуль для генерації RAW посилань на файли у GitHub репозиторії
...
====================================================================================================
- **p_353_advanced_ui_core** ← p_354_ui_builder, p_356_ui_styles
- **p_354_ui_builder** ← p_355_ui_handlers

====================================================================================================
## 🤖 ДЛЯ ШІ: Інтеграція та використання
*Автоматично згенеровано: 2025-12-11 19:03:45*

...
*Автоматично згенеровано: 2025-12-10T21:13:14.908485*
*Оновлюється автоматично при кожному запуску системи*

====================================================================================================
## 📊 ЗАГАЛЬНА ІНФОРМАЦІЯ
====================================================================================================
- **Загальна кількість модулів**: 26
- **Секції конфігурації**: 16
- **Активних компонентів**: 37
...
### 📦 FEATURES (11 модулів)
- `[300]` **p_300_test_actions** - 
- `[301]` **p_301_app_backup** - 
- `[302]` **p_302_verbalizer** - p_302_verbalizer.py - Вербалізація тексту (цифри в слова)
- `[303]` **p_303_tts_models** - p_303_tts_models.py - Завантаження та керування моделями TTS
- `[304]` **p_304_tts_verbalizer_wrapper** - p_304_tts_verbalizer_wrapper.py - Обгортка для вербалізації тексту
- `[305]` **p_305_tts_gradio_main** - p_305_tts_gradio_main.py - Головний Gradio інтерфейс StyleTTS2
- `[310]` **p_310_tts_config** - Конфігурація TTS модуля.
- `[312]` **p_312_tts_engine** - TTS двигун - ядро синтезу мови.
- `[350]` **p_350_tts_gradio** - Мінімальний Gradio UI для тестування інтеграції TTS.
- `[355]` **p_355_tts_gradio_advanced** - Розширений Gradio UI для TTS з підтримкою Multi Dialog, SFX та налаштувань спіке
...
*Автоматично згенеровано: 2025-12-10 21:13:14*
...
**TTS компоненти:**
  - `302_verbalizer` - Сервісний компонент системи (Verbalizer)
  - `303_tts_models` - Сервісний компонент системи (TTSModels)
  - `304_tts_verbalizer_wrapper` - Сервісний компонент системи (dict)
  - `305_tts_gradio_main` - Сервісний компонент системи (dict)
  - `312_tts_engine` - Сервісний компонент системи (TTSEngine)
  - `350_tts_gradio` - Сервісний компонент системи (dict)
  - `355_tts_gradio_advanced` - Сервісний компонент системи (dict)
  - `tts_engine` - Двигун синтезу мови (TTSEngine)
  - `tts_gradio_interface` - Сервісний компонент системи (function)
  - `tts_models` - Менеджер моделей TTS (TTSModels)
  - `tts_utils` - Сервісний компонент системи (dict)
  - `verbalizer` - Вербалізатор тексту (Verbalizer)

**Графічні інтерфейси:**
  - `090_gui_manager` - Сервісний компонент системи (GUIManager)
  - `gradio_main_demo` - Головний інтерфейс Gradio (Blocks)
...
**Інше:**
  ...
  - `300_test_actions` - Сервісний компонент системи (dict)
